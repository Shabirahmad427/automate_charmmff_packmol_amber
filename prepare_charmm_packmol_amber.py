...
def write_build_scripts(outdir: Path, patches: Sequence[str], water_chain_files: Sequence[str] | None = None) -> None:
    ...
    protein_script = [
        ...
        "writepdb receptor_protein.pdb",
        "exec awk -f fix_psf_header.awk receptor_protein.psf > receptor_protein.psf.tmp",
        "exec mv receptor_protein.psf.tmp receptor_protein.psf",
        "",
    ]
    ...
    solvated.extend([
        ...
        "guesscoord",
        "writepsf x-plor cmap receptor_solvated.psf",
        "writepdb receptor_solvated.pdb",
        "exec awk -f fix_psf_header.awk receptor_solvated.psf > receptor_solvated.psf.tmp",
        "exec mv receptor_solvated.psf.tmp receptor_solvated.psf",
        "",
    ])
    ...
    parmed_script = "\n".join([
        ...
        "  -psf receptor_solvated.psf \\",
        "  -crd receptor_solvated.pdb \\",
        "  -box bounding",
        "",
        "parmout receptor_charmm.parm7 receptor_charmm.rst7",
        "go",
        "",
    ])
